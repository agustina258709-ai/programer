...
namespace praktik_5._4_auliya_xpplg1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 2. Perulangan 'while'
            // Kondisi: Selama nilai 'hitungan' lebih besar dari θ
            while (hitungan > 0)
            {
                ...
                // Ini PENTING agar perulangan tidak menjadi loop tak terbatas (infinite loop) hitungan hitungan - 1;
